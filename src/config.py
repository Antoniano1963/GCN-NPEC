...
def arg_parser():
	...
	parser.add_argument('-bs', '--batch_steps', metavar = 'BS', type=int, default=10, help = 'number of samples = batch * batch_steps')
	...
	parser.add_argument('-em', '--embed_dim', metavar = 'EM', type = int, default=256, help = 'embedding size')
	...
	parser.add_argument('-ne', '--n_encode_layers', metavar = 'NE', type = int, default=3, help = 'number of GCN layers')
